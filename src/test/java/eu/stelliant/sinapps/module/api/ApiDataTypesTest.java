...
public class ApiDataTypesTest {
  ...
  @Test
  public void id_should_throw_jackson_UnrecognizedPropertyException() throws IOException {
    ...
    // When
    Throwable exception = catchThrowable(() -> mapper.readValue(jsonDataTypes, InlineResponse2001.class));
